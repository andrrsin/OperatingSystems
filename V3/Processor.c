...
int registerD_CPU;					// register for exercise 5 V2
...
void Processor_DecodeAndExecuteInstruction()
{
	...
	case MEMADD_INST:
		...
		// 2nd ADD
		Processor_CheckOverflow(operand1, registerAccumulator_CPU, REGISTERACCUMULATOR_CPU); // check accumulator
...
// Setter for the D
void Processor_SetRegisterD(int d){
	registerD_CPU=d;
}